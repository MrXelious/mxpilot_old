...
def speed_limit_set_alert(CP: car.CarParams, CS: car.CarState, sm: messaging.SubMaster, metric: bool, soft_disable_time: int) -> Alert:
  speedLimit = sm['longitudinalPlan'].speedLimit
  speed = round(speedLimit * (CV.MS_TO_KPH if metric else CV.MS_TO_MPH))
  message = f'Cruise set to {speed} {"km/h" if metric else "mph"} speed limit'
  return Alert(
    message,
    "",
...
EVENTS: Dict[int, Dict[str, Union[Alert, AlertCallbackType]]] = {
  ...
  EventName.speedLimitActive: {
    ET.WARNING: speed_limit_set_alert,
  },
