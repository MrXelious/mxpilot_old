...
def create_lfahda_mfc(packer, lat_active, disengage_from_brakes, below_lane_change_speed, disengage_blinking_icon, hda_set_speed=0):
  values = {
...
def create_acc_commands(packer, enabled, accel, jerk, idx, lead_visible, set_speed, stopping, gas_pressed, main_enabled, escc):
  commands = []
