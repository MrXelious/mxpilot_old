...
from selfdrive.car import STD_CARGO_KG, scale_rot_inertia, scale_tire_stiffness, gen_empty_fingerprint, get_safety_config, create_button_enable_events, create_button_event
from selfdrive.car.interfaces import CarInterfaceBase

EventName = car.CarEvent.EventName
ButtonType = car.CarState.ButtonEvent.Type
BUTTONS_DICT = {CruiseButtons.ACCEL_ACC: ButtonType.accelCruise, CruiseButtons.ACCEL_CC: ButtonType.accelCruise,
                CruiseButtons.DECEL_ACC: ButtonType.decelCruise, CruiseButtons.DECEL_CC: ButtonType.decelCruise,}
...
class CarInterface(CarInterfaceBase):
  ...
  def _update(self, c):
    ...
    events.events.extend(create_button_enable_events(ret.buttonEvents, enable_pressed, enable_from_brake,
                                                     self.CS.madsEnabled, ret.cruiseState.enabled))
