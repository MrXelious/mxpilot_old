...
def fingerprint(logcan, sendcan):
  ...
  skip_fw_query = os.environ.get('SKIP_FW_QUERY', False) or not Params().get_bool("ToyotaForceSnG")
  ecu_rx_addrs = set()
  ...
  if not fixed_fingerprint and not skip_fw_query:
    ...
    cached_params = Params().get("CarParamsCache") or Params().get("CarParamsCacheSnG")
