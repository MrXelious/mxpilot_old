...
def main(sm=None, pm=None):
  ...
  CP = car.CarParams.from_bytes(params_reader.get("CarParams", block=True)if not params_reader.get_bool("ToyotaForceSnG") else
                                params_reader.get("CarParamsSnG", block=True))
